...
export const pricingPlans: PricingPlan[] = [
  {
    ...
    yearlyLabel: "$0",
    features: [
      "25 AI tutor chats per day (600/month)",
      "10 quiz generations per month",
      "5 assignment generations per month",
      "3 PDF analysis uploads per month",
      "10 AI note summaries per month",
      "2 study plan generations per month",
      "Basic study dashboard & notes",
      "Community support",
    ],
    accent: "slate",
  ...
  },
  {
    ...
    yearlyLabel: "$190",
    features: [
      "Unlimited AI tutor conversations (fair use)",
      "Unlimited AI-powered quizzes",
      "Unlimited assignment generation",
      "Unlimited PDF paper analysis",
      "Unlimited AI summaries & study plans",
  ...
  },
  {
    ...
    features: [
      "Everything in Pro",
      "Higher fair-usage AI limits & priority queue",
